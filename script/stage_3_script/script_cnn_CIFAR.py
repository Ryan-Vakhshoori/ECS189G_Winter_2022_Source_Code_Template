from code.stage_3_code.Dataset_Loader_CIFAR import Dataset_Loader_CIFAR
...
if 1:
    ...
    loaded_obj = Dataset_Loader_CIFAR('numbers', '')
    loaded_obj.dataset_source_folder_path = '../../data/stage_3_data/'
    loaded_obj.dataset_source_file_name = 'CIFAR'

    graph_obj = Graph()

    method_obj = Method_CNN_CIFAR('CIFARModel', '', [32, 64, 128, 256, 1024, 512], "", "")
    ...
    ## Aarush
    method_obj = Method_CNN_CIFAR('CIFARModel', '', [32, 64, 128, 256, 1024, 512], "adam", "")
